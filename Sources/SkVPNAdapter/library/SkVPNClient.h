...
typedef NS_ENUM(NSInteger, SkVPNProxyServerProtocol) {
    SkVPNProxyServerProtocolHTTP,
    SkVPNProxyServerProtocolHTTPS
};

NS_ASSUME_NONNULL_BEGIN

@protocol SkVPNClientDelegate <NSObject>
...
class SkVPNClient : public ClientAPI::SkVPNClient {
public:
    SkVPNClient(id<SkVPNClientDelegate> _Nonnull delegate);
    ~SkVPNClient();
...
private:
    __weak id<SkVPNClientDelegate> _Nonnull delegate;
