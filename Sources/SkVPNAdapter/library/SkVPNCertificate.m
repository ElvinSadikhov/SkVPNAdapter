...
@interface SkVPNCertificate ()

@property (nonatomic, assign) mbedtls_x509_crt *crt;

@end

@implementation SkVPNCertificate

+ (SkVPNCertificate *)certificateWithPEM:(NSData *)pemData error:(NSError * __autoreleasing *)error {
    SkVPNCertificate *certificate = [SkVPNCertificate new];
...
+ (SkVPNCertificate *)certificateWithDER:(NSData *)derData error:(NSError * __autoreleasing *)error {
    SkVPNCertificate *certificate = [SkVPNCertificate new];
