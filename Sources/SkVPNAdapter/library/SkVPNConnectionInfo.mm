...
@implementation SkVPNConnectionInfo
...
- (nonnull id)copyWithZone:(nullable NSZone *)zone {
    SkVPNConnectionInfo *info = [[SkVPNConnectionInfo allocWithZone:zone] init];
