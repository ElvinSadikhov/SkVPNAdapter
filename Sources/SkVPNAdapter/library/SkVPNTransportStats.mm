...
@implementation SkVPNTransportStats
...
- (id)copyWithZone:(NSZone *)zone {
    SkVPNTransportStats *statistics = [[SkVPNTransportStats allocWithZone:zone] init];
