 ...
 */
@interface SkVPNConfiguration : NSObject <NSCopying, NSSecureCoding>

/**
 SkVPN profile as a NSData
 */
 ...
 */
@property (nonatomic) SkVPNTransportProtocol proto;

/**
 IPv6 preference
 */
@property (nonatomic) SkVPNIPv6Preference ipv6;
...
/**
 Compression mode
 */
@property (nonatomic) SkVPNCompressionMode compressionMode;
 ...
 */
@property (nonatomic) SkVPNMinTLSVersion minTLSVersion;

/**
 Override or default the tls-cert-profile setting
 */
@property (nonatomic) SkVPNTLSCertProfile tlsCertProfile;
...
/**
 ...
 [SkVPNAdapterDelegate tick] at a frequency defined by this parameter.
 Set to 0 to disable.
 */
