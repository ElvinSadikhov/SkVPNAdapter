//
//  SkVPNConfigurationEvaluation.h
//  SkVPN Adapter
//
...
@class SkVPNServerEntry;

@interface SkVPNConfigurationEvaluation : NSObject
 ...
 */
@property (readonly, nonatomic) SkVPNTransportProtocol remoteProto;

/**
 Optional list of user-selectable VPN servers
 */
@property (nullable, readonly, nonatomic) NSArray<SkVPNServerEntry *> *servers;
