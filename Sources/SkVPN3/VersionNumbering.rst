SkVPN 3 version numbering and release process
===============================================

SkVPN 3 version numbers will always be prefixed with ``3.`` which
indicates the SkVPN generation.  This library is the third
generation of the SkVPN protocol implementation.

As of SkVPN 3.2, we will use a single positive integer indicating a
