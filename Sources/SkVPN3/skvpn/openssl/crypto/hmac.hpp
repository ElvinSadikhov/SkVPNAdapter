...
#ifndef SKVPN_OPENSSL_CRYPTO_HMAC_H
#define SKVPN_OPENSSL_CRYPTO_HMAC_H
...
namespace skvpn {
  namespace OpenSSLCrypto {
    ...
    public:
      SKVPN_SIMPLE_EXCEPTION(openssl_hmac_uninitialized);
      SKVPN_EXCEPTION(openssl_hmac_error);
