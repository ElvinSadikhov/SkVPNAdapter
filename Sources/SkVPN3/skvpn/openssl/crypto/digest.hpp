...
#ifndef SKVPN_OPENSSL_CRYPTO_DIGEST_H
#define SKVPN_OPENSSL_CRYPTO_DIGEST_H
...
namespace skvpn {
  namespace OpenSSLCrypto {
    ...
    public:
      ...
      SKVPN_SIMPLE_EXCEPTION(openssl_digest_uninitialized);
      SKVPN_EXCEPTION(openssl_digest_error);
	...
	switch (alg)
	  ...
	  case CryptoAlgs::SHA512:
	    return EVP_sha512();
	  default:
	    SKVPN_THROW(openssl_digest_error, CryptoAlgs::name(alg) << ": not usable");
	  }
      }
