...
#ifndef SKVPN_OPENSSL_BIO_BIO_MEMQ_DGRAM_H
#define SKVPN_OPENSSL_BIO_BIO_MEMQ_DGRAM_H
...
#include <skvpn/frame/memq_dgram.hpp>
  ...
  namespace bmq_dgram {
	...
	switch (cmd)
	  ...
	  case BIO_CTRL_DGRAM_SET_NEXT_TIMEOUT:
	    ...
	    break;
	  default:
	    //SKVPN_LOG("*** MemQ-dgram unimplemented ctrl method=" << cmd);
	    ret = 0;
	    break;
	  }
	return (ret);
...
#endif // SKVPN_OPENSSL_BIO_BIO_MEMQ_DGRAM_H
