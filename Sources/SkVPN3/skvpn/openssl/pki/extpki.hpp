...
namespace skvpn {
  ...
  public:
	...
	RSA_meth_free(rsa_meth);
      ...
      SKVPN_THROW(OpenSSLException, "OpenSSLContext::ExternalPKIRsaImpl: " << errtext);
    }
  ...
  private:
	...
	{
	  SKVPN_LOG("OpenSSLContext::ExternalPKIRsaImpl::rsa_priv_enc exception: " << e.what());
	  ++self->n_errors;
	  return -1;
	}
    }
  ...
  public:
      ...
      else
	{
      ...
      SKVPN_THROW(OpenSSLException, "OpenSSLContext::ExternalPKIECImpl: " << errtext);
    }
  ...
  private:
	...
	{
	  SKVPN_LOG("OpenSSLContext::ExternalPKIECImpl::ecdsa_sign exception: " << e.what());
	  return 0;
	}
    }
	...
	{
	  SKVPN_LOG("OpenSSLContext::ExternalPKIECImpl::ecdsa_sign_sig exception: " << e.what());
	}
