...
#ifndef SKVPN_OPENSSL_UTIL_ERROR_H
#define SKVPN_OPENSSL_UTIL_ERROR_H
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_EXCEPTION(ssl_exception_index);
  ...
  private:
      ...
      while (unsigned long err = ERR_get_error())
	{
	  ...
	  // for certain OpenSSL errors, translate them to an SkVPN error code,
...
#endif // SKVPN_OPENSSL_UTIL_ERROR_H
