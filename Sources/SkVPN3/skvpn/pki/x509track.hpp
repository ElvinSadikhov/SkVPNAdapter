...
#ifndef SKVPN_PKI_X509TRACK_H
#define SKVPN_PKI_X509TRACK_H
...
namespace skvpn {
  namespace X509Track {
    ...
    SKVPN_EXCEPTION(x509_track_error);
	...
	switch (type)
	  {
	  case SERIAL:
	    return "tls_serial_" + skvpn::to_string(depth);
	  case SERIAL_HEX:
	    return "tls_serial_hex_" + skvpn::to_string(depth);
	  default:
	    return "X509_" + skvpn::to_string(depth) + '_' + name(type);
	  }
      }
