...
#ifndef SKVPN_ASIO_ASIOERR_H
#define SKVPN_ASIO_ASIOERR_H

#include <string>

#include <skvpn/io/io.hpp> // was: #include <asio/error_code.hpp>
...
namespace skvpn {
  ...
  {
    skvpn_io::error_code e(err, skvpn_io::system_category());
    return e.message();
  }
