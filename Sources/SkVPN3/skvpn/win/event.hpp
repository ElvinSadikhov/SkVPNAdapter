...
#ifndef SKVPN_WIN_EVENT_H
#define SKVPN_WIN_EVENT_H
...
namespace skvpn {
  namespace Win {
	...
	if (!event.defined())
	  {
	    ...
	    SKVPN_THROW_EXCEPTION("Win::Event: cannot create Windows event: " << err.message());
	  }
      }
	...
	if (!::DuplicateHandle(GetCurrentProcess(),
	  ...
	  {
	    const Win::LastError err;
	    SKVPN_THROW_EXCEPTION("Win::Event: DuplicateHandle failed: " << err.message());
	  }
