  ...
  namespace Win {
	...
	if (!::DuplicateHandle(GetCurrentProcess(),
			       ...
			       DUPLICATE_SAME_ACCESS))
	  {
	    ...
	    SKVPN_THROW(handle_comm, "send_handle: DuplicateHandle failed: " << err.message());
	  }
	...
	if (!::DuplicateHandle(remote_process,
	  ...
	  {
	    const Win::LastError err;
	    SKVPN_THROW(handle_comm, "receive_handle: DuplicateHandle failed: " << err.message());
	  }
	return local_handle;
      }
