...
#ifndef SKVPN_COMPRESS_COMPRESS_H
#define SKVPN_COMPRESS_COMPRESS_H
...
#define SKVPN_LOG_COMPRESS(x)
#define SKVPN_LOG_COMPRESS_VERBOSE(x)

#if defined(SKVPN_DEBUG_COMPRESS)
#if SKVPN_DEBUG_COMPRESS >= 1
#undef SKVPN_LOG_COMPRESS
#define SKVPN_LOG_COMPRESS(x) SKVPN_LOG(x)
#endif
#if SKVPN_DEBUG_COMPRESS >= 2
#undef SKVPN_LOG_COMPRESS_VERBOSE
#define SKVPN_LOG_COMPRESS_VERBOSE(x) SKVPN_LOG(x)
#endif
#endif
...
#include <skvpn/compress/compnull.hpp>
#include <skvpn/compress/compstub.hpp>

#ifndef NO_LZO
#include <skvpn/compress/lzoselect.hpp>
#endif
#ifdef HAVE_LZ4
#include <skvpn/compress/lz4.hpp>
#endif
#ifdef HAVE_SNAPPY
#include <skvpn/compress/snappy.hpp>
#endif
...
namespace skvpn {
  ...
  public:
    ...
    SKVPN_SIMPLE_EXCEPTION(compressor_unavailable);
...
#endif // SKVPN_COMPRESS_COMPRESS_H
