...
// This is a special SkVPN-specific implementation of LZO decompression.
// It is generally only used when SkVPN is built without linkage to the
...
#ifndef SKVPN_COMPRESS_LZOASYM_IMPL_H
#define SKVPN_COMPRESS_LZOASYM_IMPL_H

#include <cstdint> // for std::uint32_t, etc.
#include <cstring> // for memcpy, memmove
#include <algorithm>

#include <skvpn/common/size.hpp>  // for ssize_t
#include <skvpn/common/likely.hpp> // for likely/unlikely
