...
// This class will read a standard SkVPN config file that might contain
...
#ifndef SKVPN_OPTIONS_MERGE_H
#define SKVPN_OPTIONS_MERGE_H
...
namespace skvpn {
  ...
  public:
	...
	SKVPN_THROW(merge_error, pm.status_string() << ": " << pm.error());
    }
