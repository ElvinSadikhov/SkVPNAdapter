...
#ifndef SKVPN_SERVER_VPNSERVPOOL_H
#define SKVPN_SERVER_VPNSERVPOOL_H
...
#include <skvpn/server/vpnservnetblock.hpp>
#include <skvpn/addr/ip.hpp>
#include <skvpn/addr/route.hpp>
#include <skvpn/addr/pool.hpp>

namespace skvpn {
  namespace VPNServerPool {

    SKVPN_EXCEPTION(vpn_serv_pool_error);
