...
#ifndef SKVPN_HTTP_URLPARM_H
#define SKVPN_HTTP_URLPARM_H
...
#include <skvpn/http/urlencode.hpp>
#include <skvpn/http/webexcept.hpp>
#include <skvpn/common/string.hpp>

namespace skvpn {
  namespace URL {
    SKVPN_EXCEPTION(url_parameter_error);
