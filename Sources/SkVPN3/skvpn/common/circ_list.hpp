...
// Used by the SkVPN anti-replay logic.

#ifndef SKVPN_COMMON_CIRC_LIST_H
#define SKVPN_COMMON_CIRC_LIST_H
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(circ_list_reset);
    SKVPN_SIMPLE_EXCEPTION(circ_list_index);
    SKVPN_SIMPLE_EXCEPTION(circ_list_const_index);
    SKVPN_SIMPLE_EXCEPTION(circ_list_push);
...
#endif // SKVPN_COMMON_CIRC_LIST_H
