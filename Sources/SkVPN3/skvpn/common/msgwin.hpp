...
#ifndef SKVPN_COMMON_MSGWIN_H
#define SKVPN_COMMON_MSGWIN_H
...
// Fundamental, lowest-level object of SkVPN protocol reliability layer
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(message_window_ref_by_id);
    SKVPN_SIMPLE_EXCEPTION(message_window_rm_head);
