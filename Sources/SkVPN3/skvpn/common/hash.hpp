...
#ifndef SKVPN_COMMON_HASH_H
#define SKVPN_COMMON_HASH_H
...
#define SKVPN_HASH_METHOD(T, meth)			\
  namespace std {					\
    template <>						\
    struct hash<T>					\
    {							\
...
#ifdef SKVPN_HASH128_CRC
#include <citycrc.h>
#define SKVPN_HASH128 ::CityHashCrc128WithSeed
#else
#include <city.h>
#define SKVPN_HASH128 ::CityHash128WithSeed
#endif
...
namespace skvpn {
  ...
  public:
    ...
    {
      hashval = SKVPN_HASH128((const char *)data, size, hashval);
    }
