...
#include <skvpn/common/endian_platform.hpp>

namespace skvpn {
  namespace Endian {
#   if defined(SKVPN_LITTLE_ENDIAN)
...
#   else
#   error One of SKVPN_LITTLE_ENDIAN or SKVPN_BIG_ENDIAN must be defined
#   endif
  }
} // namespace skvpn
