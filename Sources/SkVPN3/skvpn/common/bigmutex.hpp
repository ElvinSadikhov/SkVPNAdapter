...
// we provide SKVPN_ASYNC_HANDLER macro which instantiates
...
#ifndef SKVPN_COMMON_BIGMUTEX_H
#define SKVPN_COMMON_BIGMUTEX_H
...
namespace skvpn {
  namespace bigmutex {
    SKVPN_EXTERN std::recursive_mutex the_recursive_mutex;
  }

  #ifdef SKVPN_ENABLE_BIGMUTEX
    #define SKVPN_ASYNC_HANDLER \
