...
#ifndef SKVPN_COMMON_BASE64_H
#define SKVPN_COMMON_BASE64_H
...
namespace skvpn {
  ...
  class Base64 {
    ...
    public:
      SKVPN_SIMPLE_EXCEPTION(base64_decode_out_of_bound_error);
  ...
  public:
    SKVPN_SIMPLE_EXCEPTION(base64_bad_map);
    SKVPN_SIMPLE_EXCEPTION(base64_decode_error);
  ...
  SKVPN_EXTERN const Base64* base64; // GLOBAL
  SKVPN_EXTERN const Base64* base64_urlsafe; // GLOBAL
