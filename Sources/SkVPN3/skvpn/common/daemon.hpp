...
#ifndef SKVPN_COMMON_DAEMON_H
#define SKVPN_COMMON_DAEMON_H
...
#include <skvpn/common/logrotate.hpp>
#include <skvpn/common/redir.hpp>
#include <skvpn/common/usergroup.hpp>
#include <skvpn/common/logsetup.hpp>

namespace skvpn {

  SKVPN_EXCEPTION(daemon_err);
