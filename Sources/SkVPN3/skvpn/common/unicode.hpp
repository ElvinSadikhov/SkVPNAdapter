...
#ifndef SKVPN_COMMON_UNICODE_H
#define SKVPN_COMMON_UNICODE_H
...
#include <skvpn/common/unicode-impl.hpp>
#include <skvpn/buffer/buffer.hpp>

namespace skvpn {
  namespace Unicode {

    SKVPN_SIMPLE_EXCEPTION(unicode_src_overflow);
    SKVPN_SIMPLE_EXCEPTION(unicode_dest_overflow);
    SKVPN_SIMPLE_EXCEPTION(unicode_malformed);
