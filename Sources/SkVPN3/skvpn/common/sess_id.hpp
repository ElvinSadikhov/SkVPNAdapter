...
#ifndef SKVPN_COMMON_SESS_ID_H
#define SKVPN_COMMON_SESS_ID_H
...
namespace skvpn {
  ...
  SKVPN_OSTREAM(SessionID64, to_string);
  SKVPN_OSTREAM(SessionID128, to_string);
}

SKVPN_HASH_METHOD(skvpn::SessionID64, shortform);
SKVPN_HASH_METHOD(skvpn::SessionID128, shortform);
