...
// SkVPN TLS-Crypt classes

#ifndef SKVPN_CRYPTO_TLSCRYPT_H
#define SKVPN_CRYPTO_TLSCRYPT_H
...
#include <skvpn/common/memneq.hpp>
...
namespace skvpn {
  ...
  // SkVPN protocol HMAC usage for HMAC/CTR integrity checking and tls-crypt
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(ovpn_tls_crypt_context_digest_size);
    SKVPN_SIMPLE_EXCEPTION(ovpn_tls_crypt_context_bad_sizing);
    SKVPN_SIMPLE_EXCEPTION(ovpn_tls_crypt_wrong_mode);
