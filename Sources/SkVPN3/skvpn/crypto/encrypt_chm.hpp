...
// General-purpose SkVPN protocol encrypt method (CBC/HMAC) that is independent of the underlying CRYPTO_API

#ifndef SKVPN_CRYPTO_ENCRYPT_CHM_H
#define SKVPN_CRYPTO_ENCRYPT_CHM_H
