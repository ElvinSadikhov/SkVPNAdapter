...
// Base class for SkVPN data channel encryption/decryption

#ifndef SKVPN_CRYPTO_CRYPTODC_H
#define SKVPN_CRYPTO_CRYPTODC_H
...
namespace skvpn {
  ...
  public:
    ...
    struct Info {
      ...
      CryptoAlgs::KeyDerivation key_derivation = CryptoAlgs::KeyDerivation::SKVPN_PRF;
    };
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(no_data_channel_factory);
  ...
  private:
    ...
    CryptoAlgs::KeyDerivation key_derivation_ = CryptoAlgs::KeyDerivation::SKVPN_PRF;
