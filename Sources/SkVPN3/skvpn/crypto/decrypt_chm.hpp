...
// General-purpose SkVPN protocol decrypt method (CBC/HMAC) that is independent of the underlying CRYPTO_API

#ifndef SKVPN_CRYPTO_DECRYPT_CHM_H
#define SKVPN_CRYPTO_DECRYPT_CHM_H
...
namespace skvpn {
  ...
  class DecryptCHM {
  public:
    SKVPN_SIMPLE_EXCEPTION(chm_unsupported_cipher_mode);
