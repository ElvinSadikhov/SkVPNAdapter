...
// Manage SkVPN protocol Packet IDs for packet replay detection

#ifndef SKVPN_CRYPTO_PACKET_ID_H
#define SKVPN_CRYPTO_PACKET_ID_H
...
#include <skvpn/common/circ_list.hpp>
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(packet_id_wrap);
  ...
  public:
    ...
    SKVPN_SIMPLE_EXCEPTION(packet_id_not_initialized);
...
#endif // SKVPN_CRYPTO_PACKET_ID_H
