...
#ifndef SKVPN_CRYPTO_CIPHER_H
#define SKVPN_CRYPTO_CIPHER_H
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(cipher_mode_error);
    SKVPN_SIMPLE_EXCEPTION(cipher_uninitialized);
    SKVPN_SIMPLE_EXCEPTION(cipher_init_insufficient_key_material);
    SKVPN_SIMPLE_EXCEPTION(cipher_internal_error);
    SKVPN_SIMPLE_EXCEPTION(cipher_output_buffer);
