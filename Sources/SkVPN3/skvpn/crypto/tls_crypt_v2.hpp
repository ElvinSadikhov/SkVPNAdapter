...
//               packet compression.
//
//    Copyright (C) 2017-2018 SkVPN Technologies, Inc.
//
...
// Classes for handling SkVPN tls-crypt-v2 internals

#ifndef SKVPN_CRYPTO_TLS_CRYPT_V2_H
#define SKVPN_CRYPTO_TLS_CRYPT_V2_H
...
namespace skvpn {
  constexpr static const char* tls_crypt_v2_server_key_name = "SkVPN tls-crypt-v2 server key";
  constexpr static const char* tls_crypt_v2_client_key_name = "SkVPN tls-crypt-v2 client key";

  class TLSCryptV2ServerKey
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_server_key_parse_error);
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_server_key_encode_error);
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_server_key_bad_size);
    ...
    void extract_key(SkVPNStaticKey& tls_key)
    {
  ...
  public:
    ...
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_client_key_parse_error);
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_client_key_encode_error);
    SKVPN_SIMPLE_EXCEPTION(tls_crypt_v2_client_key_bad_size);

    TLSCryptV2ClientKey() = delete;

    TLSCryptV2ClientKey(TLSCryptContext::Ptr context)
      : key_size(SkVPNStaticKey::KEY_SIZE),
...
#endif /* SKVPN_CRYPTO_TLS_CRYPT_V2_H */
