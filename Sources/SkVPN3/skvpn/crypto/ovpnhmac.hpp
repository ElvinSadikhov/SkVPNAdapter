...
#ifndef SKVPN_CRYPTO_OVPNHMAC_H
#define SKVPN_CRYPTO_OVPNHMAC_H
...
namespace skvpn {
  ...
  // SkVPN protocol HMAC usage for HMAC/CBC integrity checking and tls-auth

  template <typename CRYPTO_API>
  class OvpnHMAC
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(ovpn_hmac_context_digest_size);
    SKVPN_SIMPLE_EXCEPTION(ovpn_hmac_context_bad_sizing);
  ...
  public:
    ...
    // Special HMAC for SkVPN control packets
  ...
  private:
    // Convoluting SkVPN control channel packets for HMAC:
    // <-- L1  -->   <-L2>   <L3>
