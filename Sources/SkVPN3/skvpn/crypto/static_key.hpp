...
// Classes for handling SkVPN static keys (and tls-auth keys)

#ifndef SKVPN_CRYPTO_STATIC_KEY_H
#define SKVPN_CRYPTO_STATIC_KEY_H
...
namespace skvpn {
  ...
  public:
    ...
    std::string render_hex() const { return skvpn::render_hex_generic(key_data_); }
  ...
  public:
    ...
    SKVPN_SIMPLE_EXCEPTION(static_key_parse_error);
    SKVPN_SIMPLE_EXCEPTION(static_key_bad_size);
  ...
  private:
    ...
    {
      return "-----BEGIN SkVPN Static key V1-----";
    }

    static const char *static_key_foot()
    {
      return "-----END SkVPN Static key V1-----";
    }
...
#endif // SKVPN_CRYPTO_STATIC_KEY_H
