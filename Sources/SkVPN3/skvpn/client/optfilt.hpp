...
#ifndef SKVPN_CLIENT_OPTFILT_H
#define SKVPN_CLIENT_OPTFILT_H
...
namespace skvpn {
  ...
  public:
    ...
    virtual bool filter(const Option& opt)
    {
      ...
      if (!ret)
	SKVPN_LOG("Ignored due to route-nopull: " << opt.render(Option::RENDER_TRUNC_64|Option::RENDER_BRACKET));
      return ret;
    }
