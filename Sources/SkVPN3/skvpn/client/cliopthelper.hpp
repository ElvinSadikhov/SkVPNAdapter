...
// A preliminary parser for SkVPN client configuration files.

#ifndef SKVPN_CLIENT_CLIOPTHELPER_H
#define SKVPN_CLIENT_CLIOPTHELPER_H
...
namespace skvpn {
  ...
  public:
	...
	// Alternative to "setenv CLIENT_CERT 0".  Note that as of SkVPN 2.3, this option
