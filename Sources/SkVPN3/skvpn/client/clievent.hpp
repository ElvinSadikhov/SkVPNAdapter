...
// This file describes the basic set of SkVPN client events, including the
// normal events leading up to a connection as well as error events.

#ifndef SKVPN_CLIENT_CLIEVENT_H
#define SKVPN_CLIENT_CLIEVENT_H
