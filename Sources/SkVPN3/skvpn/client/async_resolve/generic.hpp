...
#ifndef SKVPN_CLIENT_ASYNC_RESOLVE_GENERIC_H
#define SKVPN_CLIENT_ASYNC_RESOLVE_GENERIC_H
...
namespace skvpn {
  ...
  public:
    ...
    {
	resolver.async_resolve(host, port, [self=Ptr(this)](const skvpn_io::error_code& error,
...
#endif /* SKVPN_CLIENT_ASYNC_RESOLVE_GENERIC_H */
