...
#ifndef SKVPN_CLIENT_CLICONSTANTS_H
#define SKVPN_CLIENT_CLICONSTANTS_H

// Various sanity checks for different limits on SkVPN clients

namespace skvpn {
  namespace ProfileParseLimits {
    enum {
      MAX_PROFILE_SIZE=262144, // maximum size of an SkVPN configuration file
      MAX_PUSH_SIZE=262144,    // maximum size of aggregate data that can be pushed to a client
      MAX_LINE_SIZE=512,       // maximum size of an SkVPN configuration file line
      MAX_DIRECTIVE_SIZE=64,   // maximum number of chars in an SkVPN directive
