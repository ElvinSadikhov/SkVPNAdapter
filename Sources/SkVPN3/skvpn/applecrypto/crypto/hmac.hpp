...
#ifndef SKVPN_APPLECRYPTO_CRYPTO_HMAC_H
#define SKVPN_APPLECRYPTO_CRYPTO_HMAC_H

// Wrap the Apple HMAC API defined in <CommonCrypto/CommonHMAC.h> so that
// it can be used as part of the crypto layer of the SkVPN core.
...
#include <skvpn/applecrypto/crypto/digest.hpp>
...
namespace skvpn {
  namespace AppleCrypto {
    ...
    public:
      SKVPN_EXCEPTION(digest_cannot_be_used_with_hmac);
      SKVPN_SIMPLE_EXCEPTION(hmac_uninitialized);
      SKVPN_SIMPLE_EXCEPTION(hmac_keysize_error);
