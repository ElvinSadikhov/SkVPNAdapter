...
#ifndef SKVPN_APPLECRYPTO_CRYPTO_CIPHER_H
#define SKVPN_APPLECRYPTO_CRYPTO_CIPHER_H
...
namespace skvpn {
  namespace AppleCrypto {
    ...
    public:
      SKVPN_SIMPLE_EXCEPTION(apple_cipher_mode_error);
      SKVPN_SIMPLE_EXCEPTION(apple_cipher_uninitialized);
      SKVPN_EXCEPTION(apple_cipher_error);
...
#endif
	  default:
	    SKVPN_THROW(apple_cipher_error, CryptoAlgs::name(alg) << ": not usable");
	  }
      }
