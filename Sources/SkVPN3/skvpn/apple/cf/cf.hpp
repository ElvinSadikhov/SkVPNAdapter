...
#ifndef SKVPN_APPLECRYPTO_CF_CF_H
#define SKVPN_APPLECRYPTO_CF_CF_H
...
#define SKVPN_CF_WRAP(cls, castmeth, cftype, idmeth) \
    template <> \
    struct Type<cftype> \
    { \
...
namespace skvpn {
  namespace CF
  {
    ...
    SKVPN_CF_WRAP(String, string_cast, CFStringRef, CFStringGetTypeID)
    SKVPN_CF_WRAP(Number, number_cast, CFNumberRef, CFNumberGetTypeID)
    SKVPN_CF_WRAP(Bool, bool_cast, CFBooleanRef, CFBooleanGetTypeID)
    SKVPN_CF_WRAP(Data, data_cast, CFDataRef, CFDataGetTypeID)
    SKVPN_CF_WRAP(Array, array_cast, CFArrayRef, CFArrayGetTypeID)
    SKVPN_CF_WRAP(MutableArray, mutable_array_cast, CFMutableArrayRef, CFArrayGetTypeID)
    SKVPN_CF_WRAP(Dict, dict_cast, CFDictionaryRef, CFDictionaryGetTypeID)
    SKVPN_CF_WRAP(MutableDict, mutable_dict_cast, CFMutableDictionaryRef, CFDictionaryGetTypeID)
    SKVPN_CF_WRAP(Error, error_cast, CFErrorRef, CFErrorGetTypeID);
...
#endif // SKVPN_APPLECRYPTO_CF_CF_H
