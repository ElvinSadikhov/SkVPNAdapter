...
// A class that handles statistics tracking in an SkVPN session

#ifndef SKVPN_LOG_SESSIONSTATS_H
#define SKVPN_LOG_SESSIONSTATS_H
...
#endif // SKVPN_LOG_SESSIONSTATS_H
