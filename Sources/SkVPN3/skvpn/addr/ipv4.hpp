...
#ifndef SKVPN_ADDR_IPV4_H
#define SKVPN_ADDR_IPV4_H
...
#include <skvpn/common/endian.hpp>
...
namespace skvpn {
  ...
  namespace IPv4 {
    ...
    SKVPN_EXCEPTION(ipv4_exception);
	...
	*(base_type*)bytestr = ntohl(u.addr);
	...
	skvpn_io::ip::address_v4 a = skvpn_io::ip::make_address_v4(ipstr, ec);
	if (ec)
	...
	return from_string(ipstr, nullptr);
      ...
      {
	const skvpn_io::ip::address_v4 a = to_asio();
	...
	return os.str();
      ...
      static Addr from_asio(const skvpn_io::ip::address_v4& asio_addr)
      {
	Addr ret;
	...
	return ret;
      ...
      skvpn_io::ip::address_v4 to_asio() const
      {
	return skvpn_io::ip::address_v4(u.addr);
      }
...
#ifdef HAVE_CITYHASH
SKVPN_HASH_METHOD(skvpn::IPv4::Addr, hashval);
#endif

#endif // SKVPN_ADDR_IPV4_H
