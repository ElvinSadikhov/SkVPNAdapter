...
#ifndef SKVPN_SSL_SSLAPI_H
#define SKVPN_SSL_SSLAPI_H
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_EXCEPTION(ssl_options_error);
    SKVPN_EXCEPTION(ssl_context_error);
    SKVPN_EXCEPTION(ssl_external_pki);
    SKVPN_SIMPLE_EXCEPTION(ssl_ciphertext_in_overflow);
