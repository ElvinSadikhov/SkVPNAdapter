...
#ifndef SKVPN_SSL_TLSPRF_H
#define SKVPN_SSL_TLSPRF_H
...
#include <skvpn/buffer/bufcomplete.hpp>
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(tlsprf_uninitialized);
    SKVPN_SIMPLE_EXCEPTION(tlsprf_client_server_mismatch);
    ...
    void generate_key_expansion(SkVPNStaticKey& dest, const TLSPRF& peer,
    ...
    static void skvpn_PRF (const unsigned char *secret,
  ...
  private:
    ...
    static void gen_exp(SkVPNStaticKey& dest, const TLSPRF& client, const ProtoSessionID& psid_client,
			const TLSPRF& server, const ProtoSessionID& psid_server)
    {
      static const char master_secret_id[] = "SkVPN master secret";
      static const char key_expansion_id[] = "SkVPN key expansion";
  ...
  public:
    ...
    virtual void generate_key_expansion(SkVPNStaticKey& dest,
