...
#ifndef SKVPN_SSL_IS_SKVPN_PROTOCOL_H
#define SKVPN_SSL_IS_SKVPN_PROTOCOL_H

#include <algorithm>                // for std::min

#include <skvpn/common/size.hpp>  // for size_t

namespace skvpn {

  // Peek at the first few bytes of a session and
  // distinguishing between SkVPN or SSL protocols.
  inline bool is_skvpn_protocol(const unsigned char *p, const size_t len)
  {
