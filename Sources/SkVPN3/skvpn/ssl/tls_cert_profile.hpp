...
#ifndef SKVPN_SSL_TLS_CERT_PROFILE_H
#define SKVPN_SSL_TLS_CERT_PROFILE_H
...
namespace skvpn {
  namespace TLSCertProfile {
	...
	throw option_error("tls-cert-profile: unrecognized override string");
      //SKVPN_LOG("*** tls-cert-profile before=" << to_string(orig) << " override=" << override << " after=" << to_string(type));
    }
  }
}
