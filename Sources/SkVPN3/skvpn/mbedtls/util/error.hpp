...
#ifndef SKVPN_MBEDTLS_UTIL_ERROR_H
#define SKVPN_MBEDTLS_UTIL_ERROR_H
...
namespace skvpn {
  ...
  public:
	...
	errtxt += ", please see https://forums.skvpn.net/viewtopic.php?f=36&t=21873 for more info";

      // for certain mbed TLS errors, translate them to an SkVPN error code,
