...
#ifndef SKVPN_MBEDTLS_CRYPTO_CIPHER_H
#define SKVPN_MBEDTLS_CRYPTO_CIPHER_H
...
namespace skvpn {
  namespace MbedTLSCrypto {
    ...
    public:
      SKVPN_SIMPLE_EXCEPTION(mbedtls_cipher_mode_error);
      SKVPN_SIMPLE_EXCEPTION(mbedtls_cipher_uninitialized);
    ...
    public:
      SKVPN_EXCEPTION(mbedtls_cipher_error);
	...
	switch (alg)
	  ...
	  default:
	    SKVPN_THROW(mbedtls_cipher_error, CryptoAlgs::name(alg) << ": not usable");
	  }
      }
    };
  }
