...
#ifndef SKVPN_MBEDTLS_CRYPTO_DIGEST_H
#define SKVPN_MBEDTLS_CRYPTO_DIGEST_H
...
namespace skvpn {
  namespace MbedTLSCrypto {
    ...
    public:
      ...
      SKVPN_SIMPLE_EXCEPTION(mbedtls_digest_uninitialized);
      SKVPN_SIMPLE_EXCEPTION(mbedtls_digest_final_overflow);
      SKVPN_EXCEPTION(mbedtls_digest_error);
	...
	switch (alg)
	  ...
	  default:
	    SKVPN_THROW(mbedtls_digest_error, CryptoAlgs::name(alg) << ": not usable");
	  }
      }
