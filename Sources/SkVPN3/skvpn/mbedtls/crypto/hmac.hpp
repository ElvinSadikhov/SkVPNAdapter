...
#ifndef SKVPN_MBEDTLS_CRYPTO_HMAC_H
#define SKVPN_MBEDTLS_CRYPTO_HMAC_H
...
namespace skvpn {
  namespace MbedTLSCrypto {
    ...
    public:
      SKVPN_SIMPLE_EXCEPTION(mbedtls_hmac_uninitialized);
      SKVPN_EXCEPTION(mbedtls_hmac_error);
