...
// Method to generate a Frame object for typical SkVPN usage

#ifndef SKVPN_FRAME_FRAME_INIT_H
#define SKVPN_FRAME_FRAME_INIT_H
...
namespace skvpn {
			       ...
			       const bool verbose)
  {
    ...
    if (verbose)
      SKVPN_LOG("Frame=" << headroom << '/' << payload << '/' << tailroom
...
#endif // SKVPN_FRAME_FRAME_INIT_H
