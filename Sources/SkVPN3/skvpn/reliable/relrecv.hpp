...
#ifndef SKVPN_RELIABLE_RELRECV_H
#define SKVPN_RELIABLE_RELRECV_H

#include <skvpn/common/size.hpp>
#include <skvpn/common/exception.hpp>
#include <skvpn/common/msgwin.hpp>
#include <skvpn/reliable/relcommon.hpp>
...
namespace skvpn {
  ...
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(rel_next_sequenced_not_ready);
...
#endif // SKVPN_RELIABLE_RELRECV_H
