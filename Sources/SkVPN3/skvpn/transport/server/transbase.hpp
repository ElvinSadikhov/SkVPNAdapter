...
#ifndef SKVPN_TRANSPORT_SERVER_TRANSBASE_H
#define SKVPN_TRANSPORT_SERVER_TRANSBASE_H
...
#include <skvpn/server/servhalt.hpp>
#include <skvpn/server/peerstats.hpp>
#include <skvpn/server/peeraddr.hpp>
...
namespace skvpn {
  ...
  struct TransportServerFactory : public RC<thread_unsafe_refcount>
  {
    ...
    virtual TransportServer::Ptr new_server_obj(skvpn_io::io_context& io_context) = 0;
  };
