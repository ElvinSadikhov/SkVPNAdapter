...
#ifndef SKVPN_TRANSPORT_GREMLIN_H
#define SKVPN_TRANSPORT_GREMLIN_H
...
namespace skvpn {
  namespace Gremlin {
    ...
    public:
      ...
      DelayedQueue(skvpn_io::io_context& io_context,
	...
	next_event.async_wait([self=Ptr(this)](const skvpn_io::error_code& error)
			      {
				if (!error)
				  {
    ...
    {
    public:
      SendRecvQueue(skvpn_io::io_context& io_context,
