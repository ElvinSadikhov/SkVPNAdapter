...
#ifndef SKVPN_TRANSPORT_PKTSTREAM_H
#define SKVPN_TRANSPORT_PKTSTREAM_H
...
namespace skvpn {
  ...
  // Used to encapsulate SkVPN packets onto a stream transport such as TCP,
  // or extract them from the stream.
  class PacketStream
  {
  public:
    SKVPN_SIMPLE_EXCEPTION(embedded_packet_size_error);
    SKVPN_SIMPLE_EXCEPTION(packet_not_fully_formed);
...
#endif // SKVPN_TRANSPORT_PKTSTREAM_H
