...
#ifndef SKVPN_TRANSPORT_CLIENT_TRANSBASE_H
#define SKVPN_TRANSPORT_CLIENT_TRANSBASE_H
...
namespace skvpn {
  ...
  struct TransportClientParent
  {
    ...
    virtual bool transport_is_skvpn_protocol() = 0;
...
#endif // SKVPN_TRANSPORT_CLIENT_TRANSBASE_H
