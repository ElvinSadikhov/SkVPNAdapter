...
#ifndef SKVPN_TRANSPORT_CLIENT_TCPCLI_H
#define SKVPN_TRANSPORT_CLIENT_TCPCLI_H
...
#include <skvpn/transport/tlslink.hpp>
#endif
...
namespace skvpn {
  namespace TCPTransport {
    ...
    class Client : public TransportClient, AsyncResolvableTCP
    {
      ...
      typedef Link<skvpn_io::ip::tcp, Client*, false> LinkImpl;
#ifdef SKVPN_TLS_LINK
      typedef TLSLink<skvpn_io::ip::tcp, Client*, false> LinkImplTLS;
#endif
	...
	SKVPN_LOG("Contacting " << server_endpoint << " via "
		    << server_protocol.str());
