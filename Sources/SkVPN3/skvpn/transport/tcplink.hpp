...
#ifndef SKVPN_TRANSPORT_TCPLINK_H
#define SKVPN_TRANSPORT_TCPLINK_H
...
#include <skvpn/transport/tcplinkcommon.hpp>
...
namespace skvpn {
  namespace TCPTransport {
	...
	Base::queue_send_buffer(buf);
      ...
      {
	bool requeue = true;
	SKVPN_LOG_TCPLINK_VERBOSE("TCP recv raw=" << Base::raw_mode_read << " size=" << bytes_recvd);
