...
#ifndef SKVPN_TUN_MAC_CLIENT_TUNCLI_H
#define SKVPN_TUN_MAC_CLIENT_TUNCLI_H
...
#include <skvpn/tun/mac/client/tunsetup.hpp>
...
namespace skvpn {
  namespace TunMac {
    ...
    typedef skvpn_io::posix::stream_descriptor TUNStream;
	...
	if (!impl)
	  {
		...
		{
		  SKVPN_LOG("TunPersist: new tun context");
