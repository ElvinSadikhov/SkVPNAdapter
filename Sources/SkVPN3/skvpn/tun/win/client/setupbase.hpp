...
#ifndef SKVPN_TUN_WIN_CLIENT_SETUPBASE_H
#define SKVPN_TUN_WIN_CLIENT_SETUPBASE_H
...
#include <skvpn/tun/win/ringbuffer.hpp>
...
namespace skvpn {
  namespace TunWin {
    ...
    struct SetupFactory : public RC<thread_unsafe_refcount>
    {
      ...
      virtual SetupBase::Ptr new_setup_obj(skvpn_io::io_context& io_context, bool wintun) = 0;
    };
  }
}
