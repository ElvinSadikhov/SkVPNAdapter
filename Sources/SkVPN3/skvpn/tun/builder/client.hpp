...
#ifndef SKVPN_TUN_BUILDER_CLIENT_H
#define SKVPN_TUN_BUILDER_CLIENT_H
...
namespace skvpn {
  namespace TunBuilderClient {
    ...
    SKVPN_EXCEPTION(tun_builder_error);
	...
	return new ClientConfig;
      ...
      TunClient::Ptr new_tun_client_obj(skvpn_io::io_context& io_context,
