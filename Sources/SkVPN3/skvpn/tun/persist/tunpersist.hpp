...
#ifndef SKVPN_TUN_PERSIST_TUNPERSIST_H
#define SKVPN_TUN_PERSIST_TUNPERSIST_H

#include <skvpn/common/size.hpp>
#include <skvpn/tun/persist/tunwrap.hpp>
...
namespace skvpn {
  ...
  public:
	...
	try {
	  ...
	  SKVPN_LOG("*** TUN BUILDER CAPTURE" << std::endl << capture->to_string());
	}
	catch (const std::exception& e)
	  {
	    SKVPN_LOG("*** TUN BUILDER CAPTURE exception: " << e.what());
	  }
      }
#endif
