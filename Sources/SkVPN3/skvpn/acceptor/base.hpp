...
#ifndef SKVPN_ACCEPTOR_LISTENER_BASE_RC
#define SKVPN_ACCEPTOR_LISTENER_BASE_RC RC<thread_unsafe_refcount>
#endif

namespace skvpn {
  namespace Acceptor {

    struct ListenerBase : public SKVPN_ACCEPTOR_LISTENER_BASE_RC
    {
      typedef RCPtr<ListenerBase> Ptr;

      virtual void handle_accept(AsioPolySock::Base::Ptr sock, const skvpn_io::error_code& error) = 0;
    };
    ...
    struct Base : public RC<thread_unsafe_refcount>
    {
      ...
      virtual void async_accept(ListenerBase* listener,
				...
				skvpn_io::io_context& io_context) = 0;
