...
namespace skvpn {
  namespace Acceptor {
    ...
    {
      SKVPN_EXCEPTION(unix_acceptor_error);
	...
	if (unix_mode)
      ...
      skvpn_io::local::stream_protocol::endpoint local_endpoint;
      skvpn_io::basic_socket_acceptor<skvpn_io::local::stream_protocol> acceptor;
    };
