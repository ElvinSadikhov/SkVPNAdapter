...
// package SKVPN_PACKAGE

import java.util.HashSet;

public class SkVPNClientThread extends ClientAPI_SkVPNClient implements Runnable {
	...
	// Tun builder methods.
	// Methods documented in skvpn/tun/builder/base.hpp
	...
	thread = new Thread(this, "SkVPNClientThread");
	thread.start();
    }
    ...
    // ClientAPI_SkVPNClient (C++ class) overrides
