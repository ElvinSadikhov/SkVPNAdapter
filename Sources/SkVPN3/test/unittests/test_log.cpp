...
// The ovpncli.cpp file is not all SKVPN_EXTERN safe and totally breaks
...
// This file needs to included with SKVPN_EXTERN still defined otherwise
...
{  
  ...
  {    
    ...
    skvpn::ClientAPI::LogInfo logInfo(msg);
