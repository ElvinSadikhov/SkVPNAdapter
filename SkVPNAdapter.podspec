Pod::Spec.new do |s|
  ...
  s.name = "SkVPNAdapter"
  s.version = "0.8.0"
  s.summary   = "Objective-C wrapper for SkVPN library. Compatible with iOS and macOS."
  s.description = <<-DESC
    SkVPNAdapter is an Objective-C framework that allows to easily configure and establish VPN connection using SkVPN protocol.
    It is based on the original skvpn3 library so it has every feature the library has. The framework is designed to use in conjunction
  ...
  s.homepage = "https://github.com/ss-abramchuk/SkVPNAdapter"
  ...
  s.source = { :git => "https://github.com/ss-abramchuk/SkVPNAdapter.git", :tag => "#{s.version}" }
  ...
  adapter_path = "Sources/SkVPNAdapter"
  asio_path = "Sources/ASIO"
  lz4_path = "Sources/LZ4"
  mbedtls_path = "Sources/mbedTLS"
  skvpn_path = "Sources/SkVPN3"
  client_path = "Sources/SkVPNClient"
  ...
  s.xcconfig = {
    ...
    "HEADER_SEARCH_PATHS" => "\"${PODS_TARGET_SRCROOT}/#{asio_path}/asio/include/**\" \"${PODS_TARGET_SRCROOT}/#{mbedtls_path}/include/**\" \"${PODS_TARGET_SRCROOT}/#{skvpn_path}/**\""
  }


  # ――― Subspecs ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #

  s.subspec "SkVPNAdapter" do |adapter|
  ...
  s.subspec "SkVPN3" do |skvpn|
    skvpn.preserve_paths = "#{skvpn_path}/skvpn/**/*.hpp", "#{skvpn_path}/client/*.{hpp,cpp}"
  end

  s.subspec "SkVPNClient" do |client|
    client.source_files = "#{client_path}/library/*.{mm}", "#{client_path}/include/*.{hpp}"
    client.private_header_files = "#{client_path}/include/*.{hpp}"

    client.compiler_flags = "-x objective-c++", "-DUSE_ASIO", "-DUSE_ASIO_THREADLOCAL", "-DASIO_STANDALONE", "-DASIO_NO_DEPRECATED", "-DASIO_HAS_STD_STRING_VIEW", "-DHAVE_LZ4", "-DUSE_MBEDTLS", "-DSKVPN_FORCE_TUN_NULL", "-DUSE_TUN_BUILDER"
  end
